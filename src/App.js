...
const listaRestaurante = [
  {nombre:"Roldos", direccion:"av de la prensa", tipo:"Panaderia", imagen:""},
...
function App() {
  ...
  return (
    <div className="App">
      ...
      {
        listaRestaurante.map((r) => <Restaurante nombre={r.nombre} direccion={r.direccion} tipo={r.tipo} imagen={r.imagen} onlike={handlerLikeTotales} handlerDislikeTotales={handlerDislikeTotales} handlerlikeError={handlerlikeError}></Restaurante>)
      }
